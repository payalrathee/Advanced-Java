...
<html>
    ...
    <sql:setDataSource var="con" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/ejproj" user="root" password="payal"></sql:setDataSource>
        <sql:query dataSource="${con }" var="mcq">
